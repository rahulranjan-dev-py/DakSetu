...
export function PlanPicker({
  ...
  return (
    <section aria-label={t('plan.choose')}>
      <h2 className="mb-2 text-xs font-bold uppercase tracking-wide text-slate-500">{t('plan.choose')}</h2>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? 'border-postal-600 bg-postal-50 shadow-sm ring-1 ring-postal-600/30'
            ...
            >
              <div className="flex w-full items-center justify-between">
                <span
                  className={cn(
                    ...
                    active ? 'bg-postal-600 text-white' : 'bg-slate-100 text-slate-600 group-hover:bg-slate-200',
                  )}
                >
              ...
              <div>
                <div className={cn('text-sm font-bold leading-tight', active ? 'text-postal-800' : 'text-slate-900')}>
                  {l(plan.name)}
                </div>
                <div className="text-[11px] leading-tight text-slate-500">{l(plan.tagline)}</div>
              </div>
              <div className="mt-auto flex flex-wrap gap-x-2 text-[10px] font-medium text-slate-500">
                <span>{ageLabel}</span>
                <span>·</span>
